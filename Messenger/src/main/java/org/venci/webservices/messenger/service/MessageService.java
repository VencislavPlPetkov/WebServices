...
public class MessageService {
	...
	private Map<Long, Message> messages = DatabaseMockClass.getMessages();

	public MessageService() {

		messages.put(1L, new Message(1, "First Message", "venci"));
		messages.put(2L, new Message(2, "Second Message", "venci"));
